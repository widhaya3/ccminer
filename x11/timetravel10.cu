...
// CPU Hash
extern "C" void timetravel10_hash(void *output, const void *input)
{
...
extern "C" int scanhash_timetravel10(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done)
{
	...
	do {
		...
		*hashes_done = pdata[19] - first_nonce + throughput;
		...
		if (work->nonces[0] != UINT32_MAX)
		{
			...
			timetravel10_hash(vhash, endiandata);
...
// cleanup
extern "C" void free_timetravel10(int thr_id)
{
	if (!init[thr_id])
		return;
